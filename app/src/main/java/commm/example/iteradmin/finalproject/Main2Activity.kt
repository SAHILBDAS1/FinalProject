package commm.example.iteradmin.finalproject
...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b.setOnClickListener {
            ...
            val url="https://samples.openweathermap.org/data/2.5/weather?q=${str}&appid=b6907d289e10d714a6e88b30761fae22"
            ...
            val jsonObjectRequest:JsonObjectRequest=
                   ...
                   Response.Listener {
                       ...
                       val report:String = "Longitude:"+coord.getString("lon")+"Latitude:"+coord.getString("lat")+
